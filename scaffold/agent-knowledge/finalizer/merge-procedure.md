...
- **충돌 있음**: `.claude/agent-knowledge/finalizer/conflict-resolution.md` 참조

## Step 4: 모든 분기 완료

`artifacts/sprint-{N}-done.md` 통합 보고서 작성 — 형식은 `.claude/agent-knowledge/finalizer/archive-format.md` 참조.
