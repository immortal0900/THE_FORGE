---
name: forge-essence-format
description: "forge essence_axioms YAML frontmatter 스키마 + 처리 규칙. spec.md 상단 frontmatter에 박힘. planner Mode A에서 자동 추출, Mode B에서 검증. planner agent가 호출."
---
