---
name: forge-eval-bash-guard
description: "forge evaluator의 Bash 실행 안전 규칙. GUI mainloop/server/REPL이 evaluator 세션을 hang시키는 사고 방지. evaluator agent가 Step 2 검증 실행 시 호출."
---
