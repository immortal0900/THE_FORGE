---
name: forge-capability-yaml
description: "forge sprint-capabilities.md YAML 스키마. sprint-contract.md의 분기 1개 = capabilities[] 1개. Branch Capability Card 데이터 소스. forge-mode-contract / forge-mode-replan skill이 호출."
---
