---
name: forge-eval-procedure
description: "forge evaluator의 qa-report.md 작성 절차 Step 0-5. 컨텍스트 수집·검증 실행·코드 리뷰·점수·보고서 형식. evaluator agent가 호출."
---
...
세션 hang 방지는 `forge-eval-bash-guard` 참조.
...
essence_axioms가 있으면 Axiom Verdicts 표를 추가 — `forge-verdict-table` skill 호출.
