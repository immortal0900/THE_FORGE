---
name: forge-mode-review
description: "Planner Mode B. forge에서 spec.md가 이미 있을 때 검토 + plan-review.md 작성. 누락된 specs/도 보강. planner agent가 호출."
---
...
## Axiom Verdicts
(essence_axioms 있으면 forge-verdict-table skill 호출해서 표 작성)
